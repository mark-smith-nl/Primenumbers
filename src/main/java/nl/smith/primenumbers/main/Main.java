...
public class Main {
    ...
    public static void main(String... args) {
        ...
        PrimeNumberFactory primeNumberFactory = new PrimeNumberFactory(null, PrimeNumberFactory.FACTORY_TYPE.ALL_NUMBER_TESTER);
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            while (number.compareTo(ceiling) < 0) {
                ...
                number = number.add(primeNumberFactory.getTestOffset());
            }
